...
%    video_file="F:/movie_trailers/thewheel-got-acard_h1080p.mov"
    ...
    % Derfault params
    tmo_params = object()
    tmo_params.a:scalar= 2.36 % Contrast
    tmo_params.d:scalar = 1.17  % Shoulder
    tmo_params.midIn:scalar=24799%(0.18^(1/2.2))*(2^16-1);
    tmo_params.midOut:scalar=0.178; %This value could be change dynamically .. TODO
    ...
    %%%%%%%%%%% ENHANCE BRIGHT %%%%%%%%%%%
    eb_params = object()
    eb_params.th1=0.712; %Same as LDR2HDR 
